...
<div class="bg-white border border-stone-200 rounded-2xl overflow-hidden">
    <div class="px-6 py-5 border-b border-stone-100 flex items-center justify-between">
        <div>
            <h3 class="text-sm font-semibold text-stone-800">Edit Air</h3>
    ...
    <form method="POST" action="{{ route('generated.airs.update', $air) }}" enctype="multipart/form-data">
        @csrf @method('PUT')
        <div class="p-6">
            @if($errors->any())
            ...
            <div class="grid grid-cols-3 gap-5">
                <div class="col-span-1">
                    ...
                    <input type="text" name="mode" value="{{ $air->mode }}" placeholder="Mode" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('mode') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="agent_name" value="{{ $air->agent_name }}" placeholder="Agent Name" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('agent_name') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="p_n_r_number" value="{{ $air->p_n_r_number }}" placeholder="P N R Number" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('p_n_r_number') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="date" name="date_of_booking" value="{{ $air->date_of_booking }}" placeholder="Date Of Booking" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('date_of_booking') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="date" name="journey_date" value="{{ $air->journey_date }}" placeholder="Journey Date" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('journey_date') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="air_line" value="{{ $air->air_line }}" placeholder="Air Line" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('air_line') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="ticket_number" value="{{ $air->ticket_number }}" placeholder="Ticket Number" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('ticket_number') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="journey_from" value="{{ $air->journey_from }}" placeholder="Journey From" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('journey_from') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="journey_upto" value="{{ $air->journey_upto }}" placeholder="Journey Upto" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('journey_upto') border-red-400 bg-red-50 @enderror">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="location" value="{{ $air->location }}" placeholder="Location" class="w-full px-3.5 py-2.5 text-sm border rounded-xl outline-none transition border-stone-300 focus:border-red-700 focus:ring-2 focus:ring-red-700/10 @error('location') border-red-400 bg-red-50 @enderror">
