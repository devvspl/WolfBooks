    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="border-b border-stone-100 bg-stone-50 text-left">
                ...
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Mode</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Agent Name</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">P N R Number</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Date Of Booking</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Journey Date</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Air Line</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Ticket Number</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Journey From</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Journey Upto</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Travel Class</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Location</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Items</th>
        ...
        <tbody class="divide-y divide-stone-100">
            ...
            <tr class="hover:bg-stone-50 transition-colors">
                ...
                <td class="px-1 py-1 text-stone-700">{{ $air->mode ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->agent_name ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->p_n_r_number ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->date_of_booking ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->journey_date ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->air_line ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->ticket_number ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->journey_from ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->journey_upto ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->travel_class ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->location ?? '—' }}</td>
                <td class="px-1 py-1 text-stone-700">{{ $air->items->count() }} row(s)</td>
