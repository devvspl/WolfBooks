    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="border-b border-stone-100 bg-stone-50 text-left">
                ...
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 uppercase tracking-wider">New Option</th>
        ...
        <tbody class="divide-y divide-stone-100">
            ...
            <tr class="hover:bg-stone-50 transition-colors">
                ...
                <td class="px-6 py-4 text-stone-700">{{ $globalRegion->new_option ?? '—' }}</td>
