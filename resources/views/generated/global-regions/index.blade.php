    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="border-b border-stone-100 bg-stone-50 text-left">
                ...
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Global Region Name</th>
                <th class="px-6 py-3 text-xs font-semibold text-stone-500 tracking-wider">Global Region Code</th>
